		...
		<div class="tabla">
			...
			<table style="margin: 0 auto;text-align: center;padding: 2px;">
				...
				<?php
					...
					/*$dsn = 'id12543716_datos_personales;host=localhost';
					...
					try
					{
						...
						$datos = $con->query('SELECT dni FROM datos');
						if (!$datos) {
							...
							$dni1=75933719 ;
							$datos = $con->query('SELECT nombre FROM datos WHERE dni like ' . $con->quote($dni1)); 
							foreach($datos as $row){
							echo $row[0] . '<br/>';}
						}	
			...
			<button style="background-color: black; " type="button"><a href="contacto sin validacion.html">VOLVER A LA PAGINA DE CONTACTO</a></button>
